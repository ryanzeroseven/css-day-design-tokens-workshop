...
export class Header extends LitElement {
  /**
   * Style variants
   * - **transparent** - removes the background for the header
   */
  @property()
  variant?: 'transparent';
  ...
  /**
   * Size variants
   * - **wide** renders a wider content max width for the header for more data-heavy pages
   * - **extra-wide** renders a variant with no max width
   */
  @property()
  ...
  toggleIsActive() {
    ...
    let myEvent = new CustomEvent('toggle-header-menu', {
  ...
  render() {
    const componentClassName = classMap({
      'ds-c-header': true,
      'ds-c-header--simple': !!this.isSimple,
      'ds-c-header--transparent': this.variant === 'transparent',
      'ds-c-header--wide': this.size === 'wide',
      'ds-c-header--extra-wide': this.size === 'extra-wide',
      'ds-c-header--inverted': !!this.inverted,
      'ds-c-header--menu-only': !!this.isMenuOnly,
      'ds-c-header--absolute': !!this.isAbsolute,
      'ds-is-active': !!this.isActive
    });

    return html`
      <header class="${componentClassName}">
        <div
          class="${this.size === 'extra-wide' ? 'ds-c-header__spacing' : 'ds-c-layout-container'} ${this.size === 'wide'
            ? 'ds-c-layout-container--wide'
            : ''}"
        >
          <div class="ds-c-header__inner">
            ...
            ${!this.isSimple && !this.isMenuOnly
              ? html`<div class="ds-c-header__nav-container">
                  <div
                    class="${this.size === 'extra-wide' ? 'ds-c-header__spacing' : 'ds-c-layout-container'} ${this.size === 'wide'
                      ? 'ds-c-layout-container--wide'
                      : ''}"
                  >
                    <div class="ds-c-header__bottom-inner">
                      <nav class="ds-c-primary-nav" role="primary navigation">
            ...
            <nav class="ds-c-utility-nav" role="utility navigation">
              <ul class="ds-c-utility-nav__list">
                ${!this.isSimple && !this.isMenuOnly
                  ...
                  : html``}
                ${!this.isMenuOnly
                  ? html` <li class="ds-c-utility-nav__item ds-c-utility-nav__item--icon-only">
                      <a class="ds-c-utility-nav__link" href="#">
            ...
            ${!this.isSimple || this.isMenuOnly
              ? html`<button class="ds-c-header__menu-button" @click=${this.toggleIsActive}>
                  ${this.isActive
                    ? html`<svg
