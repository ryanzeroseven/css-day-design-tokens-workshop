...
export class Tier2Border extends LitElement {
  ...
  render() {
    return html`
      <div class="tier-2-border" style="padding: 2rem;">
        <h1 tagName="h1" variant="headline-lg">Border</h1>
        <section class="ds-c-section">
          <header class="ds-c-section__header">
            <h2 class="ds-c-section__heading">Border width</h2>
            <p>Tier 2 Border width tokens map the tier 1 border width tokens to semantic border widths.</p>
          </header>
          <ul>
            ${this.filterTokens('ds-theme-border-width').map((item) => {
              return html`
                <li>
                  <token-specimen
                    name="${item.name}"
        ...
        <section class="ds-c-section">
          <header class="ds-c-section__header">
            ...
            <p>Border radius token description</p>
          </header>
          <ul>
            ${this.filterTokens('ds-theme-border-radius').map((item) => {
              return html`
                <li>
                  <token-specimen
                    name="${item.name}  "
